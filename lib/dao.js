 ...
 * Extension = {
    ...
    // ======= self-define ======= //
    "tag": ['tag1', 'tag2', .....]。
    [非持久化属性]"download": "https://clients2.google.com/service/update2/crx?response=redirect&prodversion=38.0&x=id%3D"+$id+"%26installsource%3Dondemand%26uc"
 * }
 * Tag = {
        name : "something",
        size : 0,
...
function generateExtUrl(id) {
    return  'https://clients2.google.com/service/update2/crx?response=redirect&prodversion=38.0&x=id%3D'
        ...
        if (ids.length > 0) {
            ...
            client.multi(multiCMD).exec(function (err, extensions) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    ...
                    extensions[i].download = generateExtUrl(extensions[i].id);// 添加crx下载链接
